...
- **Latest migration**: `064_motif_extraction_jobs_generalize_parent.py` (`motif_extraction_jobs` generalized via `parent_kind` discriminator + nullable `masked_transformer_job_id` FK + nullable `k`)
