...
During implementation sessions, per-task verification uses targeted inline tests plus a background sub-agent for the full suite. See `docs/workflows/session-implement.md` step 4 for details.
