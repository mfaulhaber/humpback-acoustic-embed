...
- `EventEncoderJobsPage`, `EventEncoderCreateForm`, `EventEncoderJobTable`, and `EventEncoderDetailPage` are the active Event Encoder UI surface.
...
└── src/
    ...
    │   ├── sequence-models/     (ContinuousEmbeddingJobsPage, ContinuousEmbeddingCreateForm, ContinuousEmbeddingJobTable, ContinuousEmbeddingDetailPage, EventEncoderJobsPage, EventEncoderCreateForm, EventEncoderJobTable, EventEncoderDetailPage, plus retained generic primitives: DiscreteSequenceBar, RegionNavBar, SpanNavBar, MotifTimelineLegend, CollapsiblePanelCard)
