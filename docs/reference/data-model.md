...
- **EventSegmentationJob** (`event_segmentation_jobs`) — Pass 2 framewise segmentation job (status, parent_run_id, region_detection_job_id FK, segmentation_model_id, config_json, event_count, started_at, completed_at, error_message). Worker logic lands with Pass 2.
